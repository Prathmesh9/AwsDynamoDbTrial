...
public class CreateTablesLoadData {
	static BasicAWSCredentials credentials = new BasicAWSCredentials("AKIAJWKHZWWSIMIIND3A","08TnC4Vc1JgwGSD9mlP6FxAidKdKM3xE3WZQ9gRy");
	static AmazonDynamoDBClient client = new AmazonDynamoDBClient(credentials).withRegion(Regions.US_WEST_1);
